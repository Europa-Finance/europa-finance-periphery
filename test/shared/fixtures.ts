...
import PancakeFactory from '@europa-finance/europa-finance-core/build/PancakeFactory.json'
import IPancakePair from '@europa-finance/europa-finance-core/build/IPancakePair.json'
